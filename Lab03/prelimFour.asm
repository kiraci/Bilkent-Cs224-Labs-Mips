...
la $a0,dispM	# put dispM address into a0
...
la $a0,inv	# put dispM address into a0
...
T9:	bne $s1,9, Bye	# if s1 = 7, do these things. Else go to T7no
...
Insert_end:
	...
	#Allocate 16 bytes (4 words) memory for new node
	li 	$a0, 16 
	li 	$v0, 9
	syscall 
...
dispM:	 .asciiz		"7 - display reverse order recursively\n"
disp:	 .asciiz		"Reverse Order: "
dash:	 .asciiz		"---------"
inv:	 .asciiz		"8 - inverse the list\n"
